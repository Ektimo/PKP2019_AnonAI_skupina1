...
#camFeed.set(cv2.CAP_PROP_FRAME_WIDTH, 1280)
#camFeed.set(cv2.CAP_PROP_FRAME_HEIGHT, 720)
camFeed.set(cv2.CAP_PROP_FRAME_WIDTH, 1920)
camFeed.set(cv2.CAP_PROP_FRAME_HEIGHT, 1080)
...
detector = FaceDetector(model_path=model_path, face_tracking="none", max_frame_padding=10)
...
while camFeed.isOpened():
    ...
    if ret == True:
        if useDetectionEnhancement:
            ...
            result_container = result_container[108:972, 192:1728]
